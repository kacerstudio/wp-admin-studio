...
* Improved: Improved login page — the logo can be sized by width and height with the aspect ratio kept automatically, plus a unified look for the password reset and admin email verification screens
